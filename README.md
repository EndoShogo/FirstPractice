...
- iOSアプリケーションの本格的な実装
- E-mailとパスワードによる本格的なアカウント作成・編集機能
- E-mailへ認証メールを送り、アカウントのパスワードを変更する本格的な認証機能
...
- 短時間でwebの機能を次々に作りたかったので、AIを併用したが、自分の意図しないコード編集をAIがやってしまうことが多々あったので、agents.mdを作成し、AIに読ませ、コード編集する前に自分に必ずコード編集の提案をさせるようにしました。
